...
public class ProfilingMethodVisitorDemo2 extends AdviceAdapter {
    ...
    protected ProfilingMethodVisitorDemo2(int access, String methodName, String desc, MethodVisitor mv, String className, String fullClassName, String simpleClassName) {
